...
<style type="text/css">
	.update-nag, #wp-admin-bar-updates, .current, .update-message p, .wp-menu-name .plugin-count, .wp-menu-name .update-plugins, .wp-first-item .wp-submenu, .subsubsub .upgrade, .wp-menu-name span{
		display: none;
	}
	.update-plugins{
