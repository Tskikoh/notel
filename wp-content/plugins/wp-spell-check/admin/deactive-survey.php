			...
			<script type="text/javascript">
				jQuery(function($){
					...
					wpsc_form.submit(function(event) { 
						...
						var submit = $.post('<?php echo $this->api; ?>', form_data);
						...
						?>
							<label for="wpsc_survey_option_not_working" class="wpsc_survey_label">
								...
								<div class="wpsc_survey_option_details">Would you like us to contact you to fix this issue?<br />
									...
									<div class="wpsc-contact-form"><a href="https://www.wpspellcheck.com/report-an-issue?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=7.0.2" target="_blank">Click Here</a> to get in touch with us</div>
								</div>
							</label>
							<?php
								} elseif ($number == 2) {
							...
							<label for="wpsc_survey_option_dont_know" class="wpsc_survey_label">
								...
								<div class="wpsc_survey_option_details">You may check out our <strong>free video tutorials</strong> for WP Spell Check <a href="https://www.wpspellcheck.com/tutorials?utm_source=baseplugin&utm_campaign=plugindeac&utm_content=7.0.2" target="_blank">here</a></div>
							</label>
							<?php
								} elseif ($number == 3) {
							?>
